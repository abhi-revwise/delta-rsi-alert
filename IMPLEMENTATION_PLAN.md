...
**35 is a loosened oversold boundary.** The classic level is 30; 35 trips earlier, so you
catch pullbacks rather than only capitulation. Measured over 299 closed 4H bars (~50 days
of BTCUSD): **6 down-crosses at 35, versus 1 at 30.** So 35 gives you roughly 6x the
downside signals — earlier warning, but more of them will be ordinary dips that recover.
...
Net at 60/35: **23 signals / ~50 days, roughly 13.8 per month** (17 up, 6 down),
still skewed upward.
